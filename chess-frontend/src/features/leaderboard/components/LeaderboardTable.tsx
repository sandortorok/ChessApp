      ...
      <div className="overflow-x-auto">
        <table className="w-full">
          <thead className="bg-slate-900/50 border-b border-emerald-600/30">
            <tr>
              <th className="px-6 py-4 text-left text-sm font-semibold text-emerald-300/70">
                Rank
              </th>
              <th className="px-6 py-4 text-left text-sm font-semibold text-emerald-300/70">
                Player
              </th>
              <th className="px-6 py-4 text-center text-sm font-semibold text-emerald-300/70">
                ELO
              </th>
              <th className="px-6 py-4 text-center text-sm font-semibold text-emerald-300/70">
                Rank
