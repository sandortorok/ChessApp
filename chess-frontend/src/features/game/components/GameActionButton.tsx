...
const variantStyles: Record<ButtonVariant, string> = {
  orange:
    'bg-orange-600/20 hover:bg-orange-600/40 text-orange-300 hover:text-orange-200 border-orange-600/30 hover:border-orange-500/50',
  emerald:
    'bg-emerald-600/20 hover:bg-emerald-600/40 text-emerald-300 hover:text-emerald-200 border-emerald-600/30 hover:border-emerald-500/50',
